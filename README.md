...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mediapy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13594&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mediapy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mediapy` can be installed with:

```
conda install mediapy
```

It is possible to list all of the versions of `mediapy` available on your platform with:
